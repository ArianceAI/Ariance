...
export default function AboutSection() {
  return (
    <section className="py-20 md:py-28 bg-[#0A0907]" id="over">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#FAF7F2] leading-tight mb-6">
              Directe lijn met de oprichter.{' '}
              <em className="not-italic text-[#D97706]">Geen tussenpersonen.</em>
            </h2>
            <p className="font-sans text-base text-[#A89880] leading-[1.75] mb-5">
              Ariance is opgericht door <strong className="text-[#FAF7F2] font-semibold">Léon Ariëns</strong> —
            ...
            <p className="font-sans text-base text-[#A89880] leading-[1.75] mb-8">
              Gevestigd in Alkmaar, werkzaam door heel Nederland. Elke oplossing op maat voor uw
              branche, processen en budget. Geen standaardpakketten die half werken — maatwerk
              dat écht resultaat oplevert.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 font-sans text-sm font-semibold
                         ...
                         hover:-translate-y-1 hover:bg-[#111009] hover:shadow-[0_12px_32px_rgba(0,0,0,0.45)]
              ...
              return (
                <div
                  ...
                  className="flex gap-4 p-5 rounded-xl
                             ...
                             hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(217,119,6,0.1),0_2px_8px_rgba(0,0,0,0.35)]"
                  style={{
                    background: '#111009',
                ...
                >
                  ...
                  <div>
                    <h3 className="font-sans text-sm font-semibold text-[#FAF7F2] mb-1">{item.title}</h3>
                    <p className="font-sans text-sm text-[#A89880] leading-[1.7]">{item.text}</p>
                  </div>
                </div>
              );
            })}
