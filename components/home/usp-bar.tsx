              ...
              <div key={usp.title} className="flex flex-col gap-3">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: '0 0 16px rgba(217,119,6,0.08)',
                  }}
                >
                  <Icon size={17} className="text-[#D97706]" />
                </div>
                <div>
                  <h3 className="font-sans text-sm font-semibold text-[#FAF7F2] mb-1">{usp.title}</h3>
                  <p className="font-sans text-xs text-[#6B5A48] leading-relaxed">{usp.description}</p>
                </div>
              </div>
            );
          })}
